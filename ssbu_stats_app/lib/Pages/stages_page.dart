...
class _StagePage extends State<StagePage> {
  ...
  void initState() {
    ...
    CsvReader csvReader =
        CsvReader(filePath: 'lib/database_files/overall_stage_stats.csv');
    csvReader.getStageData();
  }
                            ...
                            itemBuilder: ((context, index) {
                              return Padding(
                                ...
                                child: Card(
                                  child: ListTile(
                                      title: Text(
                                    dataManager.topStages[index].toString(),
